        ...
        {({ zoomIn, zoomOut, centerView, resetTransform }) => (
          <>
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-4 fill-primary-250"
                viewBox="0 0 384 512"
              >
            ...
            <button
              ...
              className="absolute left-0 top-1/2 z-[80] grid h-32 w-16 -translate-y-1/2 place-items-center rounded-full text-primary-550 shadow-md transition-all md:left-8 md:h-12 md:w-12 md:bg-primary-550 md:text-primary-150 md:hover:bg-primary-150 md:hover:text-primary-550"
            >
              <PiCaretLeftBold />
            </button>
            <button
              ...
              className="absolute right-0 top-1/2 z-[80] grid h-32 w-16 -translate-y-1/2 place-items-center rounded-full text-primary-550 shadow-md transition-all md:right-8 md:h-12 md:w-12 md:bg-primary-550 md:text-primary-150 md:hover:bg-primary-150 md:hover:text-primary-550"
            >
              <PiCaretRightBold />
            </button>
            {/* toolbar */}
            <div className="xsm:gap-2 absolute left-1/2 top-7 z-[80] flex -translate-x-1/2 items-center rounded-3xl bg-primary-550 shadow-md">
              ...
              <div className="xsm:px-3 flex items-center whitespace-nowrap break-keep text-primary-150">
                <input
                  ...
                  className={
                    "mr-1 w-7 bg-primary-550 text-right text-primary-250"
                  }
                  value={val}
                ></input>{" "}
                {`/${images.length}`}

...
const StatRow: React.FC<StatRowProps> = ({ titleLeft, valueLeft, titleRight, valueRight }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 gap-5 justify-between items-center lg:gap-40 px-6 py-2 md:text-xl lg:text-2xl text-white">
...
<ProfileTitle title="Dashboard" />
            <div className="bg-gradient-to-bl from-primary-550 to-primary-650 py-10 md:py-20 px-5 lg:px-28 text-center  border-secondary-500 border  rounded-3xl shadow-lg text-white">
                <p className="text-xl md:text-2xl lg:text-3xl">Number of Participated Segments</p>

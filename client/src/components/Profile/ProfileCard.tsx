            ...
            <div className="flex flex-col lg:flex-row items-center justify-between  gap-10">
                ...
                <div className="flex flex-col lg:flex-row items-center space-x-4">
                    ...
                    <div className="space-y-5 text-center lg:text-left  lg:mt-0 mt-5">
                        <p className="lg:text-6xl font-bold text-3xl md:text-4xl">BINOD</p>
                        <p className="text-xl md:text-2xl text-gray-400">aa.b@c.com</p>
                        <p className="text-xl md:text-2xl text-gray-400">Notre Dame College, Dhaka</p>
                        <button className="transition mt-2 mx-auto lg:mx-0 px-9 md:px-10 py-4 text-xl border-4 border-primary-400 hover:bg-transparent bg-primary-400 font-medium rounded-full flex items-center space-x-2">
                            <span >INIT ID-Card</span>
                            <FaDownload />
                        </button>
                        <button className="transition mt-2 mx-auto lg:mx-0 px-10 py-4 text-xl border-4 border-primary-400 hover:bg-primary-400 font-medium rounded-full flex items-center space-x-2">

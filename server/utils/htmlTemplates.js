const htmlCreator = (mode, data) => {
  ...
  `;
    ...
    subject = "Verify your account | NDITC";
    body = `
    <h3>Hey ${data.client.fullName} please verify your account by clicking the link below</h3>
    <a href="${data.info.verificationLink}">Verify Account</a>
    `;
